...
class CellConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # background + 2 (trap, cell)
...
class HSYAADataset(utils.Dataset):
    def load_data(self, dataset_dir, subset):
        ...
        self.add_class("objects", 1, "trap")
        self.add_class("objects", 2, "cell")
        
        self.class_name_to_ids = {'trap':1, 'cell':2}
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                class_names = [list(r['region_attributes']['name']) for r in a['regions'].values()]
            else:
                polygons = [r['shape_attributes'] for r in a['regions']]
                class_names = [r['region_attributes']['name'] for r in a['regions']]
